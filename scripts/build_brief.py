...
FEEDS = [
    ...
    ("nvidia", "NVIDIA", "https://developer.nvidia.com/blog/feed/", "lab", 2, False),
    ("aws-ml", "AWS ML", "https://aws.amazon.com/blogs/machine-learning/feed/", "lab", 2, False),
    # --- tech media ---------------------------------------------------------
    ("techcrunch", "TechCrunch", "https://techcrunch.com/category/artificial-intelligence/feed/", "media", 3, False),
    ("verge", "The Verge", "https://www.theverge.com/rss/ai-artificial-intelligence/index.xml", "media", 3, False),
    ("ars", "Ars Technica", "https://arstechnica.com/ai/feed/", "media", 3, False),
    ("wired", "WIRED", "https://www.wired.com/feed/tag/ai/latest/rss", "media", 3, False),
    ("mit-tr", "MIT Tech Review", "https://www.technologyreview.com/feed/", "media", 3, False),
    ("ieee", "IEEE Spectrum", "https://spectrum.ieee.org/feeds/topic/artificial-intelligence.rss", "media", 3, False),
    ...
    ("raschka", "Sebastian Raschka", "https://magazine.sebastianraschka.com/feed", "analysis", 3, False),
    ("github-blog", "GitHub Blog", "https://github.blog/feed/", "analysis", 2, False),
    # --- community ----------------------------------------------------------
